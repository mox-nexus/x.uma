// @generated
impl serde::Serialize for CelMatcher {
    #[allow(deprecated)]
        ...
        S: serde::Serializer,
    {
        ...
        let mut len = 0;
        if self.expr_match.is_some() {
            len += 1;
        }
        if !self.description.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.CelMatcher", len)?;
        if let Some(v) = self.expr_match.as_ref() {
            struct_ser.serialize_field("exprMatch", v)?;
        }
        if !self.description.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CelMatcher {
    #[allow(deprecated)]
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "exprMatch" | "expr_match" => Ok(GeneratedField::ExprMatch),
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CelMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.CelMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CelMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut expr_match__ = None;
                let mut description__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::ExprMatch => {
                            if expr_match__.is_some() {
                                return Err(serde::de::Error::duplicate_field("exprMatch"));
                            }
                            expr_match__ = map_.next_value()?;
                        }
                ...
                Ok(CelMatcher {
                    expr_match: expr_match__,
                    description: description__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.CelMatcher", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DoubleRangeMatcher {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if !self.range_matchers.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.DoubleRangeMatcher", len)?;
        if !self.range_matchers.is_empty() {
            struct_ser.serialize_field("rangeMatchers", &self.range_matchers)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for DoubleRangeMatcher {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "rangeMatchers" | "range_matchers" => Ok(GeneratedField::RangeMatchers),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = DoubleRangeMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.DoubleRangeMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DoubleRangeMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut range_matchers__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::RangeMatchers => {
                            if range_matchers__.is_some() {
                                return Err(serde::de::Error::duplicate_field("rangeMatchers"));
                            }
                            range_matchers__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(DoubleRangeMatcher {
                    range_matchers: range_matchers__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.DoubleRangeMatcher", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for double_range_matcher::RangeMatcher {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.DoubleRangeMatcher.RangeMatcher", len)?;
        if !self.ranges.is_empty() {
...
impl<'de> serde::Deserialize<'de> for double_range_matcher::RangeMatcher {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = double_range_matcher::RangeMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.DoubleRangeMatcher.RangeMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<double_range_matcher::RangeMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(double_range_matcher::RangeMatcher {
                    ranges: ranges__.unwrap_or_default(),
                    on_match: on_match__,
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.DoubleRangeMatcher.RangeMatcher", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HttpAttributesCelMatchInput {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.HttpAttributesCelMatchInput", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for HttpAttributesCelMatchInput {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = HttpAttributesCelMatchInput;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.HttpAttributesCelMatchInput")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<HttpAttributesCelMatchInput, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(HttpAttributesCelMatchInput {
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.HttpAttributesCelMatchInput", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for IpMatcher {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.IPMatcher", len)?;
        if !self.range_matchers.is_empty() {
            struct_ser.serialize_field("rangeMatchers", &self.range_matchers)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for IpMatcher {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = IpMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.IPMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<IpMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut range_matchers__ = None;
        ...
        deserializer.deserialize_struct("xds.r#type.matcher.v3.IPMatcher", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ip_matcher::IpRangeMatcher {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.IPMatcher.IPRangeMatcher", len)?;
        if !self.ranges.is_empty() {
            struct_ser.serialize_field("ranges", &self.ranges)?;
        }
        if let Some(v) = self.on_match.as_ref() {
        ...
        if self.exclusive {
            struct_ser.serialize_field("exclusive", &self.exclusive)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ip_matcher::IpRangeMatcher {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "ranges" => Ok(GeneratedField::Ranges),
                            "onMatch" | "on_match" => Ok(GeneratedField::OnMatch),
                            "exclusive" => Ok(GeneratedField::Exclusive),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ip_matcher::IpRangeMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.IPMatcher.IPRangeMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ip_matcher::IpRangeMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut ranges__ = None;
                let mut on_match__ = None;
                let mut exclusive__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Ranges => {
                            if ranges__.is_some() {
                        ...
                        GeneratedField::Exclusive => {
                            if exclusive__.is_some() {
                                return Err(serde::de::Error::duplicate_field("exclusive"));
                            }
                            exclusive__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(ip_matcher::IpRangeMatcher {
                    ranges: ranges__.unwrap_or_default(),
                    on_match: on_match__,
                    exclusive: exclusive__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.IPMatcher.IPRangeMatcher", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Int32RangeMatcher {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.Int32RangeMatcher", len)?;
        if !self.range_matchers.is_empty() {
            struct_ser.serialize_field("rangeMatchers", &self.range_matchers)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for Int32RangeMatcher {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = Int32RangeMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.Int32RangeMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<Int32RangeMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut range_matchers__ = None;
                ...
                Ok(Int32RangeMatcher {
                    range_matchers: range_matchers__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.Int32RangeMatcher", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for int32_range_matcher::RangeMatcher {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.Int32RangeMatcher.RangeMatcher", len)?;
        if !self.ranges.is_empty() {
            struct_ser.serialize_field("ranges", &self.ranges)?;
        }
        if let Some(v) = self.on_match.as_ref() {
...
impl<'de> serde::Deserialize<'de> for int32_range_matcher::RangeMatcher {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = int32_range_matcher::RangeMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.Int32RangeMatcher.RangeMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<int32_range_matcher::RangeMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut ranges__ = None;
                ...
                Ok(int32_range_matcher::RangeMatcher {
                    ranges: ranges__.unwrap_or_default(),
                    on_match: on_match__,
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.Int32RangeMatcher.RangeMatcher", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Int64RangeMatcher {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.Int64RangeMatcher", len)?;
        if !self.range_matchers.is_empty() {
            struct_ser.serialize_field("rangeMatchers", &self.range_matchers)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for Int64RangeMatcher {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = Int64RangeMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.Int64RangeMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<Int64RangeMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut range_matchers__ = None;
                ...
                Ok(Int64RangeMatcher {
                    range_matchers: range_matchers__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.Int64RangeMatcher", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for int64_range_matcher::RangeMatcher {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.Int64RangeMatcher.RangeMatcher", len)?;
        if !self.ranges.is_empty() {
            struct_ser.serialize_field("ranges", &self.ranges)?;
        }
        if let Some(v) = self.on_match.as_ref() {
...
impl<'de> serde::Deserialize<'de> for int64_range_matcher::RangeMatcher {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = int64_range_matcher::RangeMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.Int64RangeMatcher.RangeMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<int64_range_matcher::RangeMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut ranges__ = None;
                ...
                Ok(int64_range_matcher::RangeMatcher {
                    ranges: ranges__.unwrap_or_default(),
                    on_match: on_match__,
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.Int64RangeMatcher.RangeMatcher", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for matcher::OnMatch {
        ...
        S: serde::Serializer,
    {
        ...
        if self.keep_matching {
            struct_ser.serialize_field("keepMatching", &self.keep_matching)?;
        }
        if let Some(v) = self.on_match.as_ref() {
            match v {
...
impl serde::Serialize for ServerNameMatcher {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.ServerNameMatcher", len)?;
        if !self.domain_matchers.is_empty() {
            struct_ser.serialize_field("domainMatchers", &self.domain_matchers)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ServerNameMatcher {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "domainMatchers" | "domain_matchers" => Ok(GeneratedField::DomainMatchers),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ServerNameMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.ServerNameMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ServerNameMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut domain_matchers__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::DomainMatchers => {
                            if domain_matchers__.is_some() {
                                return Err(serde::de::Error::duplicate_field("domainMatchers"));
                            }
                            domain_matchers__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(ServerNameMatcher {
                    domain_matchers: domain_matchers__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.ServerNameMatcher", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for server_name_matcher::DomainMatcher {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.r#type.matcher.v3.ServerNameMatcher.DomainMatcher", len)?;
        if !self.domains.is_empty() {
...
impl<'de> serde::Deserialize<'de> for server_name_matcher::DomainMatcher {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = server_name_matcher::DomainMatcher;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.r#type.matcher.v3.ServerNameMatcher.DomainMatcher")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<server_name_matcher::DomainMatcher, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(server_name_matcher::DomainMatcher {
                    domains: domains__.unwrap_or_default(),
                    on_match: on_match__,
                })
            }
        }
        deserializer.deserialize_struct("xds.r#type.matcher.v3.ServerNameMatcher.DomainMatcher", FIELDS, GeneratedVisitor)
    }
}
