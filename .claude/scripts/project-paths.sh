...
# Note: rumi-claude was folded into rumi core as `claude` feature (Phase 15)
CRATE_CLAUDE_SRC="${CRATE_CORE_SRC}/claude"
...
export CRATE_EXT_TEST CRATE_EXT_HTTP CRATE_CLAUDE_SRC
