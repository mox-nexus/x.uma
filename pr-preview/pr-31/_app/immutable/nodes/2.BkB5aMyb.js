import{a as l,f as u,s as d}from"../chunks/C7IGVkAW.js";import{i as U}from"../chunks/CP6AjnRL.js";import{p as F,s as a,f as H,a as L,c as t,n as X,$ as j,v as A,r as e,t as b,w as o,x as z}from"../chunks/DYiHVAw2.js";import{e as T,s as B,a as J}from"../chunks/DcI0cIgz.js";import{h as K}from"../chunks/IoRnOvJ0.js";import{b as V}from"../chunks/CHmSkPxT.js";import{M as Y}from"../chunks/B_WnHLoT.js";import{Q as w,b as Z}from"../chunks/DzP7CByw.js";var ee=u('<meta name="description" content="Match structured data against rule trees. Write the rules once, evaluate them in Rust, Python, or TypeScript, and get the same answer."/>'),te=u('<article class="svelte-1uha8ag"><h3 class="svelte-1uha8ag"> </h3> <pre class="svelte-1uha8ag"><code> </code></pre></article>'),ae=u("<li><a> </a></li>"),se=u('<article class="svelte-1uha8ag"><h3 class="svelte-1uha8ag"> </h3> <p class="svelte-1uha8ag"> </p> <ul class="svelte-1uha8ag"></ul></article>'),re=u(`<section class="hero svelte-1uha8ag"><h1 class="svelte-1uha8ag">Write the rules once.<br/><em class="svelte-1uha8ag">Get the same answer everywhere.</em></h1> <p class="svelte-1uha8ag">x.uma is a matcher engine implementing the xDS Unified Matcher API. One config, five
		...
		is a separate port, which is why one matcher works everywhere.</p></section> <section class="quadrants svelte-1uha8ag"><h2 class="svelte-1uha8ag">Where to go next</h2> <div class="grid svelte-1uha8ag"></div></section>`,1);function me(C,D){F(D,!1);const W=["tutorial","how-to","reference","explanation"],k=`{
  "matchers": [
    {
      "predicate": {
        "type": "single",
...
matcher.evaluate(ctx);   // "read-handler"`}];U();var E=re();K("1uha8ag",s=>{var r=ee();X(()=>{j.title="x.uma — cross-platform matcher engine"}),l(s,r)});var p=a(H(E),2),N=a(t(p),4);Y(N,{config:k,context:$}),A(2),e(p);var g=a(p,2),R=a(t(g),4);T(R,5,()=>G,s=>s.lang,(s,r)=>{var i=te(),n=t(i),h=t(n,!0);e(n);var m=a(n,2),c=t(m),f=t(c,!0);e(c),e(m),e(i),b(()=>{d(h,o(r).lang),d(f,o(r).code)}),l(s,i)}),e(R),e(g);var v=a(g,4),P=a(t(v),2),q=t(P);q.textContent=`Context  →  DataInput  →  MatchingData  →  InputMatcher  →  bool
            domain-        erased           domain-
            specific                        agnostic`,e(P),A(2),e(v);var S=a(v,2),M=a(t(S),2);T(M,5,()=>W,s=>s,(s,r)=>{const i=z(()=>Z(o(r)));var n=se(),h=t(n),m=t(h,!0);e(h);var c=a(h,2),f=t(c,!0);e(c);var I=a(c,2);T(I,5,()=>o(i).slice(0,4),y=>y.slug,(y,O)=>{var _=ae(),x=t(_),Q=t(x,!0);e(x),e(_),b(()=>{B(x,"href",`${V??""}/docs/${o(O).slug??""}`),d(Q,o(O).title)}),l(y,_)}),e(I),e(n),b(()=>{J(n,`--quadrant: ${w[o(r)].token??""}`),d(m,w[o(r)].label),d(f,w[o(r)].blurb)}),l(s,n)}),e(M),e(S),l(C,E),L()}export{me as component};
